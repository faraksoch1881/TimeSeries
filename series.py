...
data_second_column = data.dropna(subset=[data.columns[1]])
data_third_column = data.dropna(subset=[data.columns[2]])
...
for i, (ax, data_column) in enumerate(zip(axs, [data_second_column, data_third_column, data_fourth_column])):
